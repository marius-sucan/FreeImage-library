...
// has been chosen. HEIF and AVIF also page, image sequences one page per frame.
// Their frames are always whole pictures, so nothing has to be composited there;
// AVIF_PLAYBACK and HEIF_PLAYBACK only ask for them as 32-bit images, which is
// the form this loop wants.
//
